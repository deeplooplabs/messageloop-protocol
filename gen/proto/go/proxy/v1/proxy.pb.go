...
const file_proxy_v1_proxy_proto_rawDesc = "" +
	...
	"\fpayload_json\x18\x06 \x01(\tR\vpayloadJson\"\x8b\x01\n" +
	"\bRPCReply\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x122\n" +
	"\x05error\x18\x02 \x01(\v2\x1c.messageloop.shared.v1.ErrorR\x05error\x12\x18\n" +
	"\apayload\x18\x03 \x01(\fR\apayload\x12!\n" +
	"\fpayload_json\x18\x04 \x01(\tR\vpayloadJson\"\x8b\x01\n" +
	...
	"ProxyProtoP\x01ZJgithub.com/deeploop-dev/messageloop-protocol/gen/proto/go/proxy/v1;proxyv1\xa2\x02\x03MPX\xaa\x02\x14Messageloop.Proxy.V1\xca\x02\x14Messageloop\\Proxy\\V1\xe2\x02 Messageloop\\Proxy\\V1\\GPBMetadata\xea\x02\x16Messageloop::Proxy::V1b\x06proto3"
