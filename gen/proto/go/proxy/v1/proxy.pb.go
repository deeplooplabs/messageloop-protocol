...
type RPCRequest struct {
	...
	PayloadString string                 `protobuf:"bytes,6,opt,name=payload_string,json=payloadString,proto3" json:"payload_string,omitempty"`
...
type RPCReply struct {
	...
	PayloadString string                 `protobuf:"bytes,4,opt,name=payload_string,json=payloadString,proto3" json:"payload_string,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proxy_v1_proxy_proto_rawDesc = "" +
	"\n" +
	"\x14proxy/v1/proxy.proto\x12\x14messageloop.proxy.v1\x1a\x16shared/v1/errors.proto\"\x9a\x01\n" +
	"\n" +
	"RPCRequest\x12\x0e\n" +
	...
	"\x0epayload_string\x18\x06 \x01(\tR\rpayloadString\"\x9a\x01\n" +
	"\bRPCReply\x12\x0e\n" +
	...
	"\x0epayload_string\x18\x04 \x01(\tR\rpayloadString\"\x8b\x01\n" +
	...
	"\x0eOnDisconnected\x12+.messageloop.proxy.v1.OnDisconnectedRequest\x1a).messageloop.proxy.v1.OnDisconnectedReplyB\xe4\x01\n" +
	"\x18com.messageloop.proxy.v1B\n" +
	"ProxyProtoP\x01ZJgithub.com/deeplooplabs/messageloop-protocol/gen/proto/go/proxy/v1;proxyv1\xa2\x02\x03MPX\xaa\x02\x14Messageloop.Proxy.V1\xca\x02\x14Messageloop\\Proxy\\V1\xe2\x02 Messageloop\\Proxy\\V1\\GPBMetadata\xea\x02\x16Messageloop::Proxy::V1b\x06proto3"
...
var file_proxy_v1_proxy_proto_goTypes = []any{
	...
	(*v1.Error)(nil),              // 15: messageloop.shared.v1.Error
}
var file_proxy_v1_proxy_proto_depIdxs = []int32{
	15, // 0: messageloop.proxy.v1.RPCReply.error:type_name -> messageloop.shared.v1.Error
	15, // 1: messageloop.proxy.v1.AuthenticateReply.error:type_name -> messageloop.shared.v1.Error
	4,  // 2: messageloop.proxy.v1.AuthenticateReply.user_info:type_name -> messageloop.proxy.v1.UserInfo
	0,  // 3: messageloop.proxy.v1.ProxyService.RPC:input_type -> messageloop.proxy.v1.RPCRequest
	2,  // 4: messageloop.proxy.v1.ProxyService.Authenticate:input_type -> messageloop.proxy.v1.AuthenticateRequest
	5,  // 5: messageloop.proxy.v1.ProxyService.SubscribeAcl:input_type -> messageloop.proxy.v1.SubscribeAclRequest
	7,  // 6: messageloop.proxy.v1.ProxyService.OnConnected:input_type -> messageloop.proxy.v1.OnConnectedRequest
	9,  // 7: messageloop.proxy.v1.ProxyService.OnSubscribed:input_type -> messageloop.proxy.v1.OnSubscribedRequest
	11, // 8: messageloop.proxy.v1.ProxyService.OnUnsubscribed:input_type -> messageloop.proxy.v1.OnUnsubscribedRequest
	13, // 9: messageloop.proxy.v1.ProxyService.OnDisconnected:input_type -> messageloop.proxy.v1.OnDisconnectedRequest
	1,  // 10: messageloop.proxy.v1.ProxyService.RPC:output_type -> messageloop.proxy.v1.RPCReply
	3,  // 11: messageloop.proxy.v1.ProxyService.Authenticate:output_type -> messageloop.proxy.v1.AuthenticateReply
	6,  // 12: messageloop.proxy.v1.ProxyService.SubscribeAcl:output_type -> messageloop.proxy.v1.SubscribeAclReply
	8,  // 13: messageloop.proxy.v1.ProxyService.OnConnected:output_type -> messageloop.proxy.v1.OnConnectedReply
	10, // 14: messageloop.proxy.v1.ProxyService.OnSubscribed:output_type -> messageloop.proxy.v1.OnSubscribedReply
	12, // 15: messageloop.proxy.v1.ProxyService.OnUnsubscribed:output_type -> messageloop.proxy.v1.OnUnsubscribedReply
	14, // 16: messageloop.proxy.v1.ProxyService.OnDisconnected:output_type -> messageloop.proxy.v1.OnDisconnectedReply
